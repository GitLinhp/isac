...
import sip
import threading
import usrp_ofdm_burst_large_scale_ofdm_burst_source as ofdm_burst_source  # embedded python block



class usrp_ofdm_burst_large_scale(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address="type=x4xx,mgmt_addr=192.168.1.100,addr=192.168.10.2", freq=6.0e9):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "usrp_ofdm_burst_large_scale")
...
def main(top_block_cls=usrp_ofdm_burst_large_scale, options=None):
    if options is None:
