...
# Title: MPSK Style1 Burst USRP
# Author: niwelcome
# Description: Style1 QPSK burst TX + continuous RX constellation
...
import time
import mpsk_stage6_usrp_style1_mpsk_burst_source as mpsk_burst_source  # embedded python block
import sip
import threading



class mpsk_stage6_usrp_style1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "MPSK Style1 Burst USRP", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("MPSK Style1 Burst USRP")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "mpsk_stage6_usrp_style1")
        ...
        self.mpsk_burst_source = mpsk_burst_source.blk(samp_rate=samp_rate, burst_ms=burst_ms, idle_ms=idle_ms, tx_amp=tx_amp, sps=sps, excess_bw=excess_bw, time_lead_s=time_lead_s, startup_delay_s=startup_delay_s)
        ...
        self.connect((self.mpsk_burst_source, 0), (self.blocks_tag_debug_0, 0))
        self.connect((self.mpsk_burst_source, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.mpsk_burst_source, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_sps(self, sps):
        ...
        self.mpsk_burst_source.sps = self.sps
    ...
    def set_excess_bw(self, excess_bw):
        ...
        self.set_rrc_taps(firdes.root_raised_cosine(32,32,1.0/self.sps,self.excess_bw,11*self.sps*32))
        self.mpsk_burst_source.excess_bw = self.excess_bw
    ...
    def set_tx_amp(self, tx_amp):
        self.tx_amp = tx_amp
        self.mpsk_burst_source.tx_amp = self.tx_amp
    ...
    def set_time_lead_s(self, time_lead_s):
        ...
        self.mpsk_burst_source.time_lead_s = self.time_lead_s
    ...
    def set_startup_delay_s(self, startup_delay_s):
        ...
        self.mpsk_burst_source.startup_delay_s = self.startup_delay_s
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.mpsk_burst_source.samp_rate = self.samp_rate
    ...
    def set_idle_ms(self, idle_ms):
        ...
        self.mpsk_burst_source.idle_ms = self.idle_ms
    ...
    def set_burst_ms(self, burst_ms):
        ...
        self.mpsk_burst_source.burst_ms = self.burst_ms
...
def main(top_block_cls=mpsk_stage6_usrp_style1, options=None):
