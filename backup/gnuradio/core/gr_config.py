...
def merge_config(
    ...
    return EffectiveConfig(
        ...
        range_resolution=float(sp.range_resolution_monostatic),
        doppler_resolution=float(sp.doppler_resolution),
        velocity_resolution=float(sp.velocity_resolution_monostatic),
        R_max=float(sp.max_range_monostatic),
        v_max=float(sp.max_velocity_monostatic),
