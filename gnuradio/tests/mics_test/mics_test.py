...
class mics_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address="type=x4xx,serial=33ABFDE,mgmt_addr=192.168.1.101,addr=192.168.11.2,clock_source=external,time_source=external"):
        ...
        self.record_file_path = record_file_path = "/home/caict/Desktop/isac/gnuradio/tests/mics_test/dataset/run_001/range_profiles"
        ...
        self.connect((self.ofdm_range_profile_0, 1), (self.blocks_selector_0, 0))
