...
class sine(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address="type=x4xx,mgmt_addr=192.168.1.100,addr=192.168.10.2", freq=6.0e9):
        gr.top_block.__init__(self, "Sine", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sine")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, freq, 0.8, 0, 0)
