...
# Description: USRP OFDM radar zero-Doppler range profile (full 0~R_max). RX packet_len tags via echotimer; range spectrum via qtgui_vector_sink_f. Stop via GUI (not kill -9) so file_meta segments flush completely.
