...
class usrp_ofdm_sink_source_dd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address="type=x4xx,serial=349B642,mgmt_addr=192.168.1.100,addr=192.168.10.2,clock_source=internal,time_source=internal"):
        ...
        self.top_grid_layout.addWidget(_record_enable_check_box, 0, 1, 1, 1)
        for r in range(0, 1):
        ...
        self.top_grid_layout.addWidget(_music_enable_check_box, 0, 0, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
    ...
    def set_record_max_frames(self, record_max_frames):
        ...
        self.ofdm_burst_rx_0.record_max_frames = self.record_max_frames
    ...
    def set_record_file_path(self, record_file_path):
        ...
        self.ofdm_burst_rx_0.record_file_path = self.record_file_path
    ...
    def set_record_enable(self, record_enable):
        ...
        self._record_enable_callback(self.record_enable)
        self.ofdm_burst_rx_0.record_enable = self.record_enable
