...
# Description: USRP OFDM radar 1D range profile (0~R_max) + DD spectrogram. RX packet_len tags via echotimer.
...
import sip
import threading
import usrp_ofdm_echotimer_dd_ofdm_cpi_tag_normalizer_rx_0 as ofdm_cpi_tag_normalizer_rx_0  # embedded python block
import usrp_ofdm_echotimer_dd_ofdm_cpi_tag_normalizer_tx_0 as ofdm_cpi_tag_normalizer_tx_0  # embedded python block
...
class usrp_ofdm_echotimer_dd(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address="type=x4xx,serial=349B642,mgmt_addr=192.168.1.100,addr=192.168.10.2,clock_source=external,time_source=external"):
        ...
        self.velocity_bin_step = velocity_bin_step = 2*v_max/transpose_len
        self.value_range = value_range = "Range (m)"
        ...
        self.sionna_resource_grid_tx_0 = sionna_resource_grid_tx_0.SionnaResourceGridTxBlock(fft_len=fft_len, num_symbols=transpose_len, subcarrier_spacing=subcarrier_spacing, cp_len=fft_len//4, length_tag_key=length_tag_key, num_bits_per_symbol=2, device='cpu', seed=42)
        ...
        self.radar_transpose_matrix_vcvc_0_0.set_min_output_buffer((2*fft_len*zeropadding_fac))
        ...
        self.radar_qtgui_spectrogram_plot_0 = radar.qtgui_spectrogram_plot((fft_len*zeropadding_fac), 500, value_range, 'Velocity (m/s)', 'OFDM Radar DD', [0,R_max], [0,v_max], [-15,-12], True, "packet_len")
        self.radar_ofdm_divide_vcvc_0 = radar.ofdm_divide_vcvc(fft_len, ((fft_len-len(discarded_carriers))*zeropadding_fac), discarded_carriers, 0, "packet_len")
        ...
        self.ofdm_cpi_tag_normalizer_tx_0 = ofdm_cpi_tag_normalizer_tx_0.OfdmCpiTagNormalizerBlock(fft_len=fft_len, num_symbols=transpose_len, length_tag_key=length_tag_key)
        self.ofdm_cpi_tag_normalizer_tx_0.set_min_output_buffer((2*transpose_len))
        self.ofdm_cpi_tag_normalizer_rx_0 = ofdm_cpi_tag_normalizer_rx_0.OfdmCpiTagNormalizerBlock(fft_len=fft_len, num_symbols=transpose_len, length_tag_key=length_tag_key)
        ...
        self.fft_vxx_0_1_0.set_min_output_buffer((2*fft_len*zeropadding_fac))
        self.fft_vxx_0_1 = fft.fft_vcc((fft_len*zeropadding_fac), True, window.blackmanharris(fft_len*zeropadding_fac), False, 1)
        self.fft_vxx_0_1.set_min_output_buffer((2*fft_len*zeropadding_fac))
        ...
        self.blocks_nlog10_ff_0_0 = blocks.nlog10_ff(1, (fft_len*zeropadding_fac), 0)
        ...
        self.blocks_complex_to_mag_squared_0_0 = blocks.complex_to_mag_squared((fft_len*zeropadding_fac))
        self.blocks_complex_to_mag_squared_0_0.set_min_output_buffer((2*fft_len*zeropadding_fac))
        ...
        self.connect((self.blocks_nlog10_ff_0_0, 0), (self.radar_qtgui_spectrogram_plot_0, 0))
        ...
        self.connect((self.ofdm_cpi_tag_normalizer_rx_0, 0), (self.radar_ofdm_divide_vcvc_0, 1))
        self.connect((self.ofdm_cpi_tag_normalizer_tx_0, 0), (self.radar_ofdm_divide_vcvc_0, 0))
        ...
        self.connect((self.radar_transpose_matrix_vcvc_0_0, 0), (self.blocks_complex_to_mag_squared_0_0, 0))
        ...
        self.connect((self.sionna_resource_grid_tx_0, 0), (self.ofdm_cpi_tag_normalizer_tx_0, 0))
    ...
    def set_v_max(self, v_max):
        self.v_max = v_max
        self.set_velocity_bin_step(2*self.v_max/self.transpose_len)
    ...
    def get_velocity_bin_step(self):
        return self.velocity_bin_step

    def set_velocity_bin_step(self, velocity_bin_step):
        self.velocity_bin_step = velocity_bin_step
