...
class usrp_echotimer_sync_pulse(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.radar_usrp_echotimer_cc_0 = radar.usrp_echotimer_cc(int(samp_rate), freq, int(num_delay_samp), uhd_dev_args, 0, '', 'internal', 'internal', 'TX/RX', TX_gain, 0.1, wait_to_start, 0, uhd_dev_args, 0, '', 'internal', 'internal', 'RX1', RX_gain, 0.1, wait_to_start, 0, "packet_len")
