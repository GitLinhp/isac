...
# Title: Monostatic Range Profile Playback
# Description: Replay CPI complex range profiles recorded by data_collection_monostatic and display as dB range spectrum.
...
class data_playback_monostatic(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Monostatic Range Profile Playback", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Monostatic Range Profile Playback")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "data_playback_monostatic")
        ...
        self.record_file_path = record_file_path = repo_data_dir("data", "experiment", "monostatic") + "/range_profiles_001"
        ...
        self.qtgui_vector_sink_f_0 = qtgui.vector_sink_f(
            ...
            "Range",
            "Power (dB)",
            "Monostatic Range Profile Playback",
            1, # Number of inputs
            None # parent
        )
...
def main(top_block_cls=data_playback_monostatic, options=None):
