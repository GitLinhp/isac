...
class data_collection_monostatic(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address="type=x4xx,serial=33ABFDE,mgmt_addr=192.168.1.101,addr=192.168.11.2,clock_source=external,time_source=external"):
        ...
        self.range_profile_record_limiter = range_profile_record_limiter.RangeProfileRecordLimiter(vlen_in=fft_len*zeropadding_fac, record_enable=record_enable, record_max_frames=int(record_max_frames), record_output_dir_override=None, file_sink_attr="blocks_file_sink_0", record_file_path_attr="record_file_path", record_base_name=)
        ...
        self.ofdm_range_profile = ofdm_range_profile.OfdmRangeProfileBlock(fft_len=fft_len, zeropadding_fac=zeropadding_fac, num_symbols=transpose_len)
